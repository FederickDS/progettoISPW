...
import org.example.view.CustomerViewAlternative;

import java.util.List;

public class CustomerViewControllerAlternative {
    private CustomerViewAlternative customerView;
    private BookRoom bookRoom;
    private NavigationService navigationService;
    private BeanClientDetails beanClientDetails;

    public CustomerViewControllerAlternative(NavigationService navigationService) {
        this.customerView = new CustomerViewAlternative();
    ...
    private void changeClientPassword(){
        ...
        if(!checkPassword(oldPassword, newPassword, confirmPassword, passwordBean)){
            return;
        }
    ...
    private boolean checkPassword(String oldPassword, String newPassword, String confirmPassword, String passwordBean){
        ...
        if(!newPassword.equals(confirmPassword) || newPassword.length() < 8 || newPassword.length() > 16){
    ...
    private void loadClientAndReservations() {
        ...
        this.beanClientDetails = details.getClientDetails();
